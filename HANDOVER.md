...
- [x] nest-news 告知記事（2026-09-11-onegai-feature.md）を main へ直接 push・本番確認済み
- [x] その5の見出しを `titleLines`（新設の任意 frontmatter。1要素=1行、「|」で文節）で3行に固定（edc2001）。他の記事でも長い題名は同じ仕組みで折り返しを指定できる
