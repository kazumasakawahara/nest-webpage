...
<figure class="mockup mockup--wide">
  ...
  <figcaption>▲ 同じAIでも、座っている場所が違う。パソコンの中の書類に手が届くのは、机を持ったアプリ版だけ</figcaption>
</figure>

決定的な違いは、**あなたのパソコンの中にあるもの（書類のフォルダやアプリ）に手が届くのは、アプリ版だけ**、ということ。GmailやGoogleドライブのように、インターネットの上にある道具（コネクタ）なら、ブラウザ版でもつなげます。でも、次回ご紹介する「ファイルを読み書きする手」をはじめ、手元の書類に触れる道具は、この机の上に並んでいきます。

<div class="callout">
  <span class="callout__label">2026年9月の更新</span>
  <p>2026年9月から、Claudeの「チャット」と、作業をまかせる「Cowork（コワーク）」がひとつにまとまりました。アプリ版では、手元のフォルダに加えて、<strong>アプリの中のブラウザ</strong>や、<strong>パソコンの画面を見ながらの操作</strong>（試験提供）も頼めるようになっています。どれも、アプリ版が開いている間だけ使える力です。新しい画面は、有料の Pro・Max プランから順番に届いている途中です。</p>
</div>
...
- **手元の書類に手が届く準備が整う** — パソコンの中のファイルやアプリを扱えるのは、アプリ版だけ。ここから先の回はぜんぶ、この机が前提です
